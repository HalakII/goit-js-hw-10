...
const createInfoMarkup = breed => {
  ...
  const markup = ` <div class="box-img"><img class="cat-picture" src="${breed[0].url}" alt="${breed[0].breeds[0].name}"></div><div class="box-text"><h2 class="cat-info-desc-title">${breed[0].breeds[0].name}</h2>
